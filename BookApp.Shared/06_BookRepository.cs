...
namespace BookApp.Shared
{
    ...
    public class BookRepository : IBookRepository
    {
        ...
        public BookAppDbContext Context { get; }
        ...
        {
            // 학습목적으로.. InMemory 데이터베이스에선 사용 금지
        ...
        public async Task<bool> UpdateAsync(Book model)
        {
            try
            {
                ...
                return await _context.SaveChangesAsync() > 0 ? true : false; // 정상적 수정시 true
            }
            catch (Exception e)
            {
